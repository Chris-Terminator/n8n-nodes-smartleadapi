...
// =================================================================
			{
				...
				options: [
					...
					{ name: 'Update Schedule', value: 'updateSchedule', action: 'Update the schedule of a campaign' },
					{ name: 'Update Settings', value: 'updateSettings', action: 'Update the settings of a campaign' },
					{ name: 'Update Status', value: 'updateStatus', action: 'Update the status of a campaign' },
				],
				default: 'getAll',
			},
			{
				...
				options: [
					...
					{ name: 'Update', value: 'update', action: 'Update information for a lead' },
					{ name: 'Update Category', value: 'updateCategory', action: 'Update the category for a lead within a campaign' },
				],
