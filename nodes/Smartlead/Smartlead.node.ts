		...
		properties: [
			{
				...
				options: [
					...
					// Add other resources like 'Lead', 'Account' here
				],
				default: 'campaign',
			},
			// Operations for Campaign
			{
				...
				options: [
					...
					// Add other campaign operations like 'Create', 'Delete' here
				],
				default: 'getAll',
			},
			// Add properties for your operations here. For example:
			{
				...
				displayOptions: {
					show: {
						resource: ['campaign'],
						operation: ['addLeads'], // Example for a future operation
					},
				},
		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				if (resource === 'campaign') {
					...
					// Add else if blocks for other campaign operations
				}
